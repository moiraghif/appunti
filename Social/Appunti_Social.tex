...
hanno un antenato in comune sono raggruppati in genere. Noi siamo del
genere homo specie sapiens, i generi a loro volte solo raggruppati in
famiglia. Ci siamo evoluti dagli australopitecus, da cui è uscito uomo
...
registrato, hanno pulito via tutti i neanderthal. L'altra ragione è
...
\begin{itemize}
	...
	\item
	Trasmettere un pensiero più astratto quindi circa cose che non
...
si processa), l'iperstoria invece è dipendente dalle ICT inoltre
possiamo anche processare le informazioni.
...
La rivoluzione informatica è quindi non solo rivoluzione tecnologica ma
anche scientifica.
...
\begin{itemize}
	...
	Connettività
	\item
	Mancanza di standard condivisi è un tema di grande importanza, infatti
...
\begin{enumerate}
	...
	\item
	Cosa pensano gli altri su cosa siamo?
\end{enumerate}
...
\begin{itemize}
	...
	\item
	John Locke: La tua identità è l'unità della tua coscienza e la
...
\begin{enumerate}
	...
	\item
	Aumento di dati generati dall'utente riguardante la salute.
	\item
