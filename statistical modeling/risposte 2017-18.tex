...
\end{equation*}
Con $\Sigma_Y$ matrice di varianze e covariante di $Y$, $\hat{H}$ matrice di varianze e covariante \textit{spiegate} e $\hat{\Sigma_E}$ matrice di varianze e covariante \textit{residue}.
...
H_0:\hat{B} = 0 
\end{equation*} 
per cui nel caso $H_0$ si rivelasse vera allora $\wedge$ tenderà ad 1 per la struttura stessa di $F$. \\
