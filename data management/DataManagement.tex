...
E\` dunque un modo per descrivere una soluzione in cui lo schema e i requisiti dei dati non sono definiti in partenza, ma vengono delineati al momento dell'interrogazione: si tratta dello "schema on read", caratteristico di un approccio "bottom up", nel quale l'osservazione "sperimentale" avvia il processo induttivo. 
