...
\item Sfrutta le proprietà ACID :
  \begin{itemize}
  \item Atomicity: l'operazione è \textit{atomica}, ovvero o avviene per intero (COMMIT) o restituisce un errore e il database ritorna alla forma iniziare (ROLLBACK); ad esempio se si aggiornano i dati o sono aggiornati tutti o non è aggiornato nessuno.
