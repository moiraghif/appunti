...
\subsection{I 3 modelli del cloud}
...
\subsection{Le 5 proprietà del cloud}
...
\begin{enumerate}[noitemsep, topsep=0ex, leftmargin=*]
	...
	\begin{itemize}[noitemsep, topsep=0ex, leftmargin=*]
		...
		\item Affidabilità è la capacità di funzionare in situazioni particolari per un certo tempo.
	\end{itemize}
