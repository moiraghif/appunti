...
Docker è un progetto open source che ha l'obiettivo di automatizzare il deployement dell'applicazione all'interno di un software container, fornendo un livello di astrazione superiore a quello del sistema operativo. 
...
\begin{figure}[!h]
	...
	\label{fig:dlife}
\end{figure}
Il ciclo di vita di un container è così fatto (Fig \ref{fig:dlife}) e i comandi principali sono:
\begin{myitemize}
